...
def copy_mp4_files():
    ...
    videos_dir = r"/mnt/pan8T/temp_djguo/dataprocessor/data/图形化讲解/小数单模-立体几何/5.视频结果_v2/小数单模-立体几何_训练集_视频结果_part002_p1v4_p2v4_matched_481"
    ...
    output_dir = videos_dir.parent / "小数单模-立体几何_训练集_视频结果_part002_p1v4_p2v4_matched_481_collected"
