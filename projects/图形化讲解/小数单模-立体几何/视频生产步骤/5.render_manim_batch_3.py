...
# -------- 全局配置 --------
INPUT_ROOT = Path(r"/mnt/pan8T/temp_djguo/dataprocessor/data/图形化讲解/小数单模-立体几何/5.视频结果_v2/小数单模-立体几何_训练集_manim可处理格式_part003_p1v4_p2v4_matched_488")
# Path(r"D:\github\svg_exp\script\test_outputs_multi")
OUTPUT_ROOT = Path(
    r"/mnt/pan8T/temp_djguo/dataprocessor/data/图形化讲解/小数单模-立体几何/5.视频结果_v2/小数单模-立体几何_训练集_视频结果_part003_p1v4_p2v4_matched_488"
)
