...
def copy_mp4_files():
    ...
    videos_dir = r"/mnt/pan8T/temp_yhzou6/数学图形化讲解/files_yhzou/data_v2/code"
    ...
    output_dir = videos_dir.parent / "collected_manim_step1_qwen_train_step2_genimi_flash"
    ...
    for subdir in subdirs:
        ...
        mp4_files = list(subdir.rglob("*manim.py"))
            ...
            for mp4_file in mp4_files:
                ...
                try:
                    ...
                    if uuid_name in file_counter:
                        ...
                        new_name = f"{uuid_name}_{file_counter[uuid_name]}manim.py"
                    else:
                        file_counter[uuid_name] = 0
                        new_name = f"{uuid_name}manim.py"
